...
const HistoryMessageHelpSheet = ({
  ...
  return (
    <CustomBottomSheet
      ...
      onClose={onClose}
      snapPoints={['85%']}
      title={t('help.history_music_help.title')}
      ...
      >
        ...
        <View style={[styles.section, {  marginTop: verticalScale(-10) }]}>
          ...
          <CustomText type="middle" style={[styles.sectionTitle, {  color: currentTheme.textSecondary, marginTop: verticalScale(10), marginBottom: verticalScale(20) }]}>
            {t('help.history_music_help.description')}
          </CustomText>
          
          <View style={styles.sectionHeader}>
            <View style={{flexDirection: 'row', alignItems: 'center', gap: scale(8)}}>  
              <CustomText type="title" bold style={styles.sectionTitle}>
                {t('help.history_music_help.section_title_one')}
              </CustomText>
              </View>
            </View>
            <CustomText type="normal" style={[styles.sectionDescription, { color: currentTheme.textSecondary }]}>
              {t('help.history_music_help.section_title_one_desc')}
            </CustomText>

            <View style={[styles.sectionHeader, { marginTop: verticalScale(15) }]}>
            <View style={{flexDirection: 'row', alignItems: 'center', gap: scale(8)}}>  
              <CustomText type="title" bold style={styles.sectionTitle}>
                {t('help.history_music_help.section_title_two')}
              </CustomText>
              </View>
            </View>
            <CustomText type="normal" style={[styles.sectionDescription, { color: currentTheme.textSecondary }]}>
              {t('help.history_music_help.section_title_two_desc')}
            </CustomText>
        ...
        <View style={styles.section}>
          ...
          <CustomText type="normal" style={[styles.sectionDescription, {  color: currentTheme.textSecondary }]}>
            {t('help.history_music_help.section_title_footer_info')}
          </CustomText>
...
export default HistoryMessageHelpSheet;
