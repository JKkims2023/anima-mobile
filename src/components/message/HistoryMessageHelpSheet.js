...
const HistoryMusicHelpSheet = ({
  ...
  return (
    <CustomBottomSheet
      ...
      onClose={onClose}
      snapPoints={['85%']}
      title={t('help.history_message_help.title')}
      ...
      >
        ...
        <View style={[styles.section, {  marginTop: verticalScale(-10) }]}>
          ...
          <CustomText type="middle" style={[styles.sectionTitle, {  color: currentTheme.textSecondary, marginTop: verticalScale(10), marginBottom: verticalScale(20) }]}>
            {t('help.history_message_help.description')}
          </CustomText>
          ...
          <View style={styles.sectionHeader}>
            ...
            <CustomText type="title" bold style={styles.sectionTitle}>
              {t('help.history_message_help.section_title_one')}
            </CustomText>
            </View>
          </View>

          <CustomText type="normal" style={[styles.sectionDescription, { color: currentTheme.textSecondary }]}>
            {t('help.history_message_help.section_title_one_desc')}
          </CustomText>
        ...
        <View style={styles.section}>
          ...
          <CustomText type="normal" style={[styles.sectionDescription, {  color: currentTheme.textSecondary }]}>
            {t('help.history_message_help.section_title_two_desc')}
          </CustomText>
...
export default HistoryMusicHelpSheet;
