/**
  * 🎬 HistoryBackgroundView Component
 * 
 * Displays history background image or video as background
...
const HistoryBackgroundView = memo(({
  persona,
  ...
  useEffect(() => {
    ...
    console.log('[HistoryBackgroundView] persona:', persona);
    console.log('[HistoryBackgroundView] hasVideo:', hasVideo);
    console.log('[HistoryBackgroundView] videoUrl:', videoUrl);
    console.log('[HistoryBackgroundView] imageUrl:', imageUrl);
  ...
  const handleVideoError = (error) => {
    console.error('[HistoryBackgroundView] Video error:', error);
    setVideoError(true);
    setIsPlaying(false);
  };
...
HistoryBackgroundView.displayName = 'HistoryBackgroundView';
...
export default HistoryBackgroundView;
