...
import Confetti from './GiftConfetti';
...
const GiftActiveEffect = ({ type = 'none', isActive = true, customWords = [] }) => {
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
...
export default React.memo(GiftActiveEffect, (prevProps, nextProps) => {
